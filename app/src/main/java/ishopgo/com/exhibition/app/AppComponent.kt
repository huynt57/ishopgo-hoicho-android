...
import ishopgo.com.exhibition.ui.main.stamp.stampwarning.StampWarningViewModel
...
interface AppComponent {
    ...
    fun inject(stampManagerViewModel: StampManagerViewModel)
    fun inject(noStampViewModel: NoStampViewModel)

...
class QrCodeShopFragment : BaseActionBarFragment(), BackpressConsumable {
    ...
    companion object {
        ...
        fun newInstance(params: Bundle): QrCodeShopFragment {
            val fragment = QrCodeShopFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view_qr_label.text = "Mã truy cập gian hàng"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        data = Toolbox.gson.fromJson(json, ShopDetail::class.java)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        view_booth_code.setOnClickListener {
            val uri = Uri.parse("tel:${data.hotline}")

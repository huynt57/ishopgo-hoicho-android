...
class SearchProductManagerFragment : BaseListFragment<List<Product>, Product>() {


    companion object {
        const val TAG = "SearchPMSalePointFragment"

        fun newInstance(arg: Bundle): SearchProductManagerFragment {
            val f = SearchProductManagerFragment()
            f.arguments = arg
            return f
        }

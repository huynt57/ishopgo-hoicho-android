...
class SearchPMBoothFragment : BaseListFragment<List<Product>, Product>() {
    companion object {
        const val TAG = "SearchPMBoothFragment"

        fun newInstance(arg: Bundle): SearchPMBoothFragment {
            val f = SearchPMBoothFragment()
            f.arguments = arg
            return f
        }

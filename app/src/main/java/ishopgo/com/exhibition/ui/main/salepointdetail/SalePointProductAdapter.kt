...
class SalePointProductAdapter(private var itemWidthRatio: Float = -1f, private var itemHeightRatio: Float = -1F) : ClickableAdapter<Product>() {
    companion object {
    ...
    override fun onBindViewHolder(holder: ViewHolder<Product>, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            listener?.click(adapterPosition, getItem(adapterPosition), DELETE_PRODUCT)
        }
    }
    ...
    internal inner class ProductHolder(view: View, private val converter: Converter<Product, ProductProvider>) : BaseRecyclerViewAdapter.ViewHolder<Product>(view) {
        ...
        override fun populate(data: Product) {
            ...
            itemView.apply {
                img_delete_product.visibility = View.VISIBLE

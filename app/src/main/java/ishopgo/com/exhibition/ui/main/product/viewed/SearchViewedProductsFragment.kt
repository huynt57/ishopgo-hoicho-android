...
class SearchViewedProductsFragment: BaseSearchActionBarFragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private lateinit var viewModel: ViewedProductsViewModel
    private lateinit var scrollListener: EndlessRecyclerViewScrollListener

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        viewModel = obtainViewModel(ViewedProductsViewModel::class.java, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getSearchField().hint = "Tìm trong sản phẩm đã xem"

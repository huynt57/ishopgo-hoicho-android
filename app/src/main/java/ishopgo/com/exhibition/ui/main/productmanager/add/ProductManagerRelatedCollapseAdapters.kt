...
class ProductManagerRelatedCollapseAdapters : ClickableAdapter<ProductManager>() {
...
return R.layout.item_product_retated_horizontal   }
    ...
    internal inner class Holder(itemView: View, private val converter: Converter<ProductManager, ProductManagerProvider>) : BaseRecyclerViewAdapter.ViewHolder<ProductManager>(itemView) {

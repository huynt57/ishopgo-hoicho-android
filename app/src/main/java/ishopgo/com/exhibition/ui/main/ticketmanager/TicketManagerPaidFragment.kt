...
class TicketManagerPaidFragment : BaseListFragment<List<Ticket>, Ticket>() {
    ...
    companion object {
        fun newInstance(params: Bundle): TicketManagerPaidFragment {
            val fragment = TicketManagerPaidFragment()

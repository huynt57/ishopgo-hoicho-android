...
class SearchPMProviderFragment : BaseListFragment<List<Product>, Product>() {
    companion object {
        const val TAG = "SearchPMProviderFragment"

        fun newInstance(arg: Bundle): SearchPMProviderFragment {
            val f = SearchPMProviderFragment()
            f.arguments = arg
            return f
        }
